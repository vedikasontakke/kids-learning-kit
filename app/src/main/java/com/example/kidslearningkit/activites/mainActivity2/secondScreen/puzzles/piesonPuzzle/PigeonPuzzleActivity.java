...
import com.example.kidslearningkit.activites.mainActivity2.secondScreen.puzzles.CustomAdapter;

import java.util.ArrayList;
import java.util.Random;

public class PigeonPuzzleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pigeon_puzzle);
